...
The guide demonstrates how to use Document Processing Capabilities within Oracle AI Database to load and chunk documents using OracleDocLoader and OracleTextSplitter respectively.
